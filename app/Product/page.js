    ...
    <div className="container mx-auto p-6">
      ...
      <div className="flex mb-6">
        <div className="w-1/2 pr-6">
          <img
            src="img.jpg" // Replace with actual product image
      ...
      <div className="flex mb-6">
        ...
        <div className="w-1/2 pr-6">
          <h2 className="text-xl font-semibold text-blue-950 mb-4"> Description  Additional video  Reveiws  Video</h2>
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          {/* Product 2 */}
          <div className="border p-4 rounded-lg shadow-md hover:shadow-lg">
            <img src="product2.jpg" alt="Product 2" className="w-full h-auto rounded-lg mb-4" />
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Comfy Sofa Set</h3>
            <p className="text-xl text-gray-700 mb-2">$85.00</p>
            <div className="flex items-center text-yellow-500">
              <span>*****</span>
              <span className="ml-2 text-sm text-gray-600">(48)</span>
            </div>
          </div>

          {/* Product 3 */}
          <div className="border p-4 rounded-lg shadow-md hover:shadow-lg">
            <img src="product3.jpg" alt="Product 3" className="w-full h-auto rounded-lg mb-4" />
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Luxurious Recliner</h3>
            <p className="text-xl text-gray-700 mb-2">$120.00</p>
            <div className="flex items-center text-yellow-500">
              <span>*****</span>
              <span className="ml-2 text-sm text-gray-600">(55)</span>
            </div>
          </div>

          {/* Product 4 */}
          <div className="border p-4 rounded-lg shadow-md hover:shadow-lg">
            <img src="product2.jpg" alt="Product 4" className="w-full h-auto rounded-lg mb-4" />
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Ergonomic Desk Chair</h3>
            <p className="text-xl text-gray-700 mb-2">$65.00</p>
            <div className="flex items-center text-yellow-500">
              <span>*****</span>
              <span className="ml-2 text-sm text-gray-600">(38)</span>
            </div>
          </div>
        </div>
      </div>
